...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-docpad/node_modules/docpad/out/lib/collections/files.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header medium">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-docpad/node_modules/docpad/out/lib/collections/files.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-docpad/node_modules/docpad/out/lib/collections/</a> &#187; files.js</div>
</div>
<div class="body">
...
&nbsp;
  FilesCollection.prototype.initialize = function(attrs, opts) {
    var base;
    <span class="missing-if-branch" title="if path not taken" >I</span>if (opts == null) {
<span class="cstat-no" title="statement not covered" >      opts = {};</span>
    }
    <span class="missing-if-branch" title="else path not taken" >E</span>if (this.options == null) {
      this.options = {};
    }
    <span class="missing-if-branch" title="else path not taken" >E</span>if ((base = this.options).name == null) {
      base.name = opts.name || <span class="branch-1 cbranch-no" title="branch not covered" >null;</span>
    }
...
&nbsp;
   ...
   */
&nbsp;
  FilesCollection.prototype.fuzzyFindOne = <span class="fstat-no" title="function not covered" >function(data, sorting, paging) {</span>
<span class="cstat-no" title="statement not covered" >    var escapedData, file, i, len, queries, query;</span>
<span class="cstat-no" title="statement not covered" >    escapedData = data != null ? data.replace(/[\/]/g, pathUtil.sep) : void 0;</span>
...
<span class="cstat-no" title="statement not covered" >    for (i = 0, len = queries.length; i &lt; len; i++) {</span>
<span class="cstat-no" title="statement not covered" >      query = queries[i];</span>
<span class="cstat-no" title="statement not covered" >      file = this.findOne(query, sorting, paging);</span>
